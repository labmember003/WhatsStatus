...
object Constants {
    ...
    const val FEEDBACK_EMAIL = "geeksoftapps@gmail.com"
    const val APP_RATE_DIALOG_INTERVAL = 10
    const val FILE_PROVIDER_AUTHORITY = "com.whatsweb.droid.provider"
    ...
    const val REMOTE_CONFIG_APP_RATE_DIALOG_INTERVAL = "app_rate_dialog_interval"
